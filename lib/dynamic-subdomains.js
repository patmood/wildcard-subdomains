module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    if (ignoreWWW) {
      ...
      if (wwwi >= 0) subdomain.splice(wwwi, 1)
    }
    ...
    /**
     * This object was added for best practice , if you
     * need to add new property to req or res please add a level deeper.
     * 
     * Sometimes req.subdomains returns [0] , with this code subdomains array always
     * return data.
     */
    req.subdomain = {};
    req.subdomain.subs = subdomains;
